...
<li>
            ...
            ?>
                ...
                <div class="line"></div>
                <div><a href="form_finance.php" class="btn btn-warning"><span class="fa fa-reply"></span> Back</a><br><br></div>
                <?php
                            ...
                            if(isset($_FILES['tmp']['name']))
                            {
                                ...
                                move_uploaded_file($file_tmp,"../admin/assets/document/finance/".$file_name);
                        
                               // Insert the submitted data from the form into the table
                                $insertquery = "INSERT INTO finance(title,type,tmp) VALUES ('$title','$type','$file_name')";
        ...
        <div class="panel-body">
            <form method="post" action="a_financeform.php" enctype="multipart/form-data">
