    ...
    <section class="register">
            ...
            <!-- Page Content Holder -->
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right  makotasamuel">
                             <?php
                                if($_SESSION['permission']==1 or $_SESSION['permission']==3){
                            ?>
		        ...
		        <div class="panel panel-default sammacmedia">
                    <div class="panel-heading">Company Car Booking List</div>
                    ...
                    <?php
                                   $a=1;
                    $query=mysqli_query($mysqli,"SELECT * FROM `carbooking`");
                     while($row=mysqli_fetch_array($query))
                        {
                          ...
                          <tr>
                            ...
                            <td style="text-align: center"><?php echo $row['return_date'];?></td>
