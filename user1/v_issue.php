                     ...
                     while($row=mysqli_fetch_array($query))
                        {
                          ...
                          <tr>
                            ...
                            <td style="text-align:center"td><?php echo $row['notes'];?></td> 
                            ...
                            <a href="v_issue.php?edited=1&idx=<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-danger"><span class="fa fa-trash"></span></a> 
                            <?php }?>
                            </center>
                              </td>
                          </tr>
