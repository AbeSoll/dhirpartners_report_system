                        ...
                        <table class="table table-striped thead-dark table-bordered table-hover" id="myTable">
                            <thead>
                              ...
                              <!--  <tr>
                                    ...
                                    <td><center>
                                        <a href="http://192.168.1.17:8080/dhirpartners_report_system/user1/carBooking.php" target="_blank" data-toggle="modal" class="btnn btn-baik"><span class="fa fa-external-link"></span> Book</a>
                                        <a href="http://192.168.1.17:8080/dhirpartners_report_system/user1/carBookingList.php" target="_blank" data-toggle="modal" class="btnn btn-warning"><span class="fa fa-eye"></span> List</a>
                                ...
                                <tr>
                                    ...
                                    <td><center>2023-06-23</center></td> 
                                    <td><center>
                                        <a href="http://192.168.1.17:8080/dhirpartners_report_system/user1/meetingBooking.php" target="_blank" data-toggle="modal" class="btnn btn-baik"><span class="fa fa-external-link"></span> Book</a>
                                        <a href="http://192.168.1.17:8080/dhirpartners_report_system/user1/meetingBookingList.php" target="_blank" data-toggle="modal" class="btnn btn-warning"><span class="fa fa-eye"></span> List</a>
