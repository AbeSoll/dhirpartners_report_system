...
<html lang="en">
    <head>
        ...
        <title>D&P Intranet Web System | IT DEPT</title>
            ...
            ?>
                ...
                <?php
                    if($_SESSION['permission']==1){
                        ?>
                <div>
                <a href="a_itform.php" class="btn btn-warning"><span class="fa fa-plus"></span> Add Document</a> 
                </div><br>
                <?php }?>

		        <div class="panel panel-default sammacmedia">
                    <div class="panel-heading">INFORMATION TECHNOLOGY FORM</div>
                    ...
                    <?php
                                   $a=1;
                    $query=mysqli_query($mysqli,"select *from `it` ");
                     while($row=mysqli_fetch_array($query))
                        {
                          ...
                          <tr>
                            ...
                            <td>
                            <center>
                            <a href="form_it_view.php?view=1&id=<?php echo $row['id'];?>" target="_blank" data-toggle="modal" class="btn btn-warning"><span class="fa fa-eye"></span></a>   
                            <a href="form_it_dw.php?tmp=<?php echo $row['tmp'];?>" data-toggle="modal" class="btnn btn-baik" onclick="return confirm('Download Document?');"><span class="fa fa-download"></span></a>
                            <?php
                                if($_SESSION['permission']==1){
                            ?>
                      ...
                      {
                          $id = $_GET['idx'];
                          if ($stmt = $mysqli->prepare("DELETE FROM it WHERE id = ? LIMIT 1"))
                          {
