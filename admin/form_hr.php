...
<li>
            ...
            ?>
		        ...
		        <div class="panel panel-default sammacmedia">
                    <div class="panel-heading">HUMAN RESOURCE FORM<center><span class='btn btn-danger'>Please contact HR (Ext:402) to request access print document</span></center></div>
                        ...
                        <table class="table table-striped thead-dark table-bordered table-hover" id="myTable">
                            <thead>
                                <tr>
                                    ...
                                    <th><center>Print Permission</center></th> 
                                    <th><center>Action</center></th> 
                                </tr>   
                                <tr>
                                    <th>i</th>
                                    <th>D&P HR Leave System (Emergency / Time Clock)</th>
                                    <th><center>Web-based System</center></th>
                                    <th><center>24-02-2023</center></th>
                                    <th><center>-</center></th> 
                                    <th><center><a href="http://60.49.81.65:8080/dnphrleave/" target="_blank" rel="noopener noreferrer" data-toggle="modal" class="btnn btn-baik"><span class="fa fa-external-link"></span> Open</a></center></th> 
                                </tr>
                            </thead>
                            <?php
                                   $a=1;
                    $query=mysqli_query($mysqli,"select *from `hr` ");
                     while($row=mysqli_fetch_array($query))
                          ...
                          <tr>
                            ...
                            <td><center>
                                <?php 
                                    if($row['status']=="0") 
                                        echo 
                                            "<span class='btn_onoff red'>Not Active</span>";
                                    else 
                                        echo 
                                            "<span class='btn_onoff green'>Active</span>";
                                ?><center>
                            </td>
                            <td>
                            <center>
                            ...
                            <?php
                                if($row['status']=="0")
                                    echo
                                    "<span class='btn btn-danger'>No action available</span>";
                                else
                                    echo    
                                    "<a href=form_hr_view.php?view=1&id=" .$row['id']." data-toggle='modal' class='btn btn-warning'><span class='fa fa-eye'></span></a>";
                            ?>
                            ...
                            ?>
                            <a href="form_hr_dw.php?tmp=<?php echo $row['tmp'];?>" data-toggle="modal" class="btnn btn-baik" onclick="return confirm('Download Document?');"><span class="fa fa-download"></span></a>
                            <a href="form_hr.php?edited=1&idx=<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-danger" onclick="return confirm('Delete Document?');"><span class="fa fa-trash"></span></a> </center>
                            <?php }?> 
                            </td>
                            </tr>
                            <?php
                      ...
                      {
                          $id = $_GET['idx'];
                          if ($stmt = $mysqli->prepare("DELETE FROM hr WHERE id = ? LIMIT 1"))
                          {
