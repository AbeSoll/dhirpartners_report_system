...
if(isset($_POST['submit']))
{
    ...
    move_uploaded_file($_FILES['attachment']['tmp_name'], 'assets/image/attachment/' . $attachment);
    ...
    if(isset($_FILES['pdf']['name']))
    {
        ...
        move_uploaded_file($file_tmp, 'assets/pdf/attachment/' . $file_name);
    }
    ...
    if($results == 1){
        ...
        <div class="alert alert-success strover animated bounce" id="sams1">
            ...
            <strong>Successfully!</strong> Report has been successfully added.
        </div>
        <?php
    }
    else{
        ...
        <div class="alert alert-danger samuel animated shake" id="sams1">
            <a href="#" class="close" data-dismiss="alert">&times;</a>
            <strong>Danger!</strong> OOPS, something went wrong.
        </div>
        <?php    
    }      
}   
