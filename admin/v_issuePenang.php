...
<html lang="en">
    <head>
        ...
        <title>D&P Intranet Web System | VIEW ISSUES</title>
        ...
        <script src="//cdn.datatables.net/buttons/2.3.6/css/buttons.dataTables.min.css"></script>
            ...
            ?>
                ...
                <?php
                    if($_SESSION['permission']==1){
                        ?>
                <div>
                <!--<a href="generate_report.php" class="btn btn-warning"><span class="fa fa-plus"></span>  Generate Report</a> -->
                </div><br>
                <?php }?>
		        ...
		        <div class="panel panel-default sammacmedia">
                        ...
                        <table class="table table-striped thead-dark table-bordered table-hover" id="example">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center">Details of issues</th>
                    ...
                    <?php
                                   $a=1;
                    $query=mysqli_query($mysqli,"select * from `cases` WHERE status=0 AND branch = 'PULAU PINANG'");
                     while($row=mysqli_fetch_array($query))
                        {
                          ...
                          <tr>
                            ...
                            <td style="text-align: center"><?php echo $row['issues'];?></td>
                            <td style="text-align: center"><?php echo $row['notes'];?></td>
                            

                            <td style="text-align: center"><?php echo $row['department'];?></td>  

                            <td style="text-align: center"><?php echo $row['solve_name'];?> 
                            <br> 
                            <br> 
                            <?php echo $row['solve_name2'];?> 
                        </td>  
                            ...
                            <a href="solvePenang.php?solve=1&id=<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-success"><span class="fa-solid fa-square-check"></span></a> 

                            <a href="#samstrover<?php echo $row['employee_id']; ?>" data-toggle="modal" class="btn btn-warning"><span class="fa fa-eye"></span></a>
                            <!-- <a href="issue_read.php?read=1&id=<?php echo $row['id'];?>" data-toggle="modal" class="btnn btn-baik"  onclick="return confirm('Mark as read?');"><span class="	fa fa-check" name="submit"></span></a> -->
                            <?php
                            if($_SESSION['permission']==1){
                            ?>
                            <a href="v_issue.php?edited=1&idx=<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-danger" onclick="return confirm('Delete Report?');"><span class="fa fa-trash"></span></a> 
                            <?php }?>
                            </center>
                              </td>
                          </tr>
...
<script type="text/javascript">
    ...
    $('#example').DataTable( {
        ...
        buttons: [
            ...
            {
                extend: 'excelHtml5',
                messageTop: 'Details of issues reported through Intranet System in from Pulau Pinang branch in March 2023',
                exportOptions: {
            ...
            {
                extend: 'pdfHtml5',
                messageTop: 'Details of issues reported through Intranet System from Pulau Pinang branch in March 2023',
