                     ...
                     while($row=mysqli_fetch_array($query))
                        {
                          ...
                          <tr>
                            ...
                            <?php
                                if($_SESSION['permission']==1){
                            ?>
                            <a href="form_it.php?edited=1&idx=<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-danger" onclick="return confirm('Delete Document?');"><span class="fa fa-trash"></span></a> </center>
                            <?php }?> 
                            </td>
                            </tr>
                            <?php
