...
<html lang="en">
    <head>
        ...
        <title>D&P Intranet Web System | ALL EMPLOYEES</title>
                     ...
                     while($row=mysqli_fetch_array($query))
                        {
                          ...
                          <tr>
                            ...
                            <td>
                            <center>
                            <a href="#samstrover<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-warning"><span class="fa fa-eye"></span></a> 
                            <a href="update_employees.php?update=1&id=<?php echo $row['id'];?>" class="btnn btn-baik"><span class="fa fa-pencil-square-o"></span></a>
                            <a href="all_employees.php?edited=1&idx=<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-danger" onclick="return confirm('Delete Employee?');"><span class="fa fa-trash"></span></a></center>
                            </td>
                          </tr>
                          <?php
