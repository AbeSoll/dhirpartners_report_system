        ...
        <div class="wrapper">
            ...
            ?>
		        ...
		        <div class="panel panel-default sammacmedia">
                    ...
                    <?php
                                   $a=1;
                    $query=mysqli_query($mysqli,"select * from `cases` WHERE status=0 AND branch = 'MUAR'");
                     while($row=mysqli_fetch_array($query))
                        {
                          ...
                          <tr>
                            ...
                            <a href="solveMuar.php?solve=1&id=<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-success"><span class="fa-solid fa-square-check"></span></a> 
...
<script type="text/javascript">
    ...
    $('#example').DataTable( {
        ...
        buttons: [
            ...
            {
                extend: 'excelHtml5',
                messageTop: 'Details of issues reported through Intranet System from Muar branch in March 2023',
                exportOptions: {
