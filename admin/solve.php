...
//update exist staff
	...
	$result2=$mysqli->query($sql2);
		if($result2)
		{
			header('Refresh:0; v_issueAll.php');
		}
} 
} 
    ...
    <body>
        ...
        <div class="wrapper">
          ...
          ?>
                ...
                <div class="line"></div>
                <div><a href="v_issueAll.php" class="btn btn-warning"><span class="fa fa-times"></span> Back</a><br><br></div>
        ...
        <div class="row form-group">
          <div class="col-lg-6">
            ...
            <option value="<?php echo $fetch['solve_name']; ?>"><?php echo $fetch['solve_name']; ?></option>
                    ...
                    <option>MUHAMMAD WAFRIHAZIQ (JHRI010)</option>
