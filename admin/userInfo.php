                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input name="employee_id" type="text" class="form-control" value="<?php echo $prow['employee_id'];?>" readonly>        
                        </div>    
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label>Branch</label> 
                            <input name="branch" type="text" class="form-control" value="<?php echo $prow['branch'];?>" readonly>        
                        </div>
                        <div class="col-md-6">
                            <label>Department</label> 
                            <input name="department" type="text" class="form-control" value="<?php echo $prow['department'];?>" readonly>    
                        </div>
                    </div>  
                    <div class="row">
                        <div class="col-md-6">
