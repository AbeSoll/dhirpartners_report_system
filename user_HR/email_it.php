                    ...
                    <div class="container" style="margin-top:20px;">
                        <div class="row justify-content-center">
                            <div class="col-md-6 col-md-offset-3" align="center">
                                <input id="name" placeholder="Username" class="form-control" value="IT Support" readonly>
                                <input id="email" placeholder="Email" class="form-control" value="it.support@dhirpartners.com.my" readonly>
