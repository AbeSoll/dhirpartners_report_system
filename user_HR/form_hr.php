            ...
            ?>
                ...
                <?php
                    if($_SESSION['permission']==4){
                        ?>
                <div>
                <a href="a_hrform.php" class="btn btn-warning"><span class="fa fa-plus"></span> Add Document</a> 
                </div><br>
                <?php }?>

		        <div class="panel panel-default sammacmedia">
                    <div class="panel-heading">HUMAN RESOURCE FORM</div>
                          ...
                          <tr>
                            ...
                            <td><center>
                                <?php 
                                    ...
                                    // green- activate
                                        echo 
                                            "<a href=activate.php?read=1&id=".$row['id']." class='btn_onoff red'>Not Active</a>";
                                    else 
                                        echo 
                                            "<a href=deactivate.php?read=1&id=".$row['id']." class='btn_onoff green'>Active</a>";
                                ?><center>
                            </td>
                            <td>
                            <center>
                            ...
                            <a href="form_hr_view.php?view=1&id=<?php echo $row['id'];?>" data-toggle="modal" class="btn btn-warning"><span class="fa fa-eye"></span></a>   
