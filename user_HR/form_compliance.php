...
<html lang="en">
    <head>
        ...
        <title>D&P Intranet Web System | COMPLIANCE DEPT</title>
            ...
            ?>
                ...
                <?php
                    if($_SESSION['permission']==1 or $_SESSION['permission']==2){
                        ?>
                <div>
                <a href="a_complianceform.php" class="btn btn-warning"><span class="fa fa-plus"></span> Add Document</a> 
                </div><br>
                <?php }?>

		        <div class="panel panel-default sammacmedia">
                    <div class="panel-heading">COMPLIANCE ASSETS FORM</div>
                    ...
                    <?php
                                   $a=1;
                    $query=mysqli_query($mysqli,"select *from `compliance` ");
                     while($row=mysqli_fetch_array($query))
                        {
                          ...
                          <tr>
                            ...
                            <td>
                            <center>
                            <a href="form_compliance_view.php?view=1&id=<?php echo $row['id'];?>" target="_blank" data-toggle="modal" class="btn btn-warning"><span class="fa fa-eye"></span></a>   
                            <a href="form_compliance_dw.php?tmp=<?php echo $row['tmp'];?>" data-toggle="modal" class="btnn btn-baik" onclick="return confirm('Download Document?');"><span class="fa fa-download"></span></a>
                            <?php
                                if($_SESSION['permission']==1 or $_SESSION['permission']==2){
                            ?>
                            <a href="form_compliance.php?edited=1&idx=<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-danger" onclick="return confirm('Delete Document?');"><span class="fa fa-trash"></span></a> </center>
                            <?php }?> 
                            </td>
                            </tr>
                            <?php
                      ...
                      {
                          $id = $_GET['idx'];
                          if ($stmt = $mysqli->prepare("DELETE FROM compliance WHERE id = ? LIMIT 1"))
                          {
